...
erDiagram
    ...
    DOCUMENT_CHUNKS {
        ...
        text content "1200 char window + 200 char overlap"
        jsonb metadata "Section headers, page estimates"
        timestamptz created_at
    }
...
- `content` (TEXT, NOT NULL): Windowed text slice (default 1200 characters, 200 character overlap).
